...
<Steps>
  ...
  <Step title="Configure Xcode Signing (Automatic)">
    ...
    ![Xcode automatic signing](/assets/ios_runneruitests_disable_automatic_signing.png)
  ...
  <Step title="Configure Xcode Signing (Manual with Fastlane)">
    ...
    ![Disable automatic signing](/assets/ios_runneruitests_disable_automatic_signing.png)
...
- [Firebase Test Lab](/documentation/integrations/firebase-test-lab) (Android)
