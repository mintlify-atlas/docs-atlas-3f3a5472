...
<Steps>
  ...
  <Step title="Set Deployment Target">
    ...
    ![Xcode macOS deployment target](https://raw.githubusercontent.com/leancodepl/patrol/master/docs/assets/macos_deployment_target.png)
  </Step>
  ...
  <Step title="Configure Build Phases">
    ...
    ![Xcode macOS build phases](https://raw.githubusercontent.com/leancodepl/patrol/master/docs/assets/macos_runner_build_phases.png)
  </Step>
  ...
  <Step title="Configure Network Entitlements">
    ...
    ![Xcode entitlements setup](https://raw.githubusercontent.com/leancodepl/patrol/master/docs/assets/macos_entitlements.png)
  </Step>
  ...
  <Step title="Set Code Signing Entitlements">
    ...
    ![Xcode RunnerUITests entitlements](https://raw.githubusercontent.com/leancodepl/patrol/master/docs/assets/macos_ui_entitlements.png)
  </Step>
</Steps>
