...
<Steps>
  ...
  <Step title="Configure Build Phases">
    ...
    ![Xcode build phases](/assets/ios_runner_build_phases.png)
  </Step>
...
<Info>
  For a complete feature parity comparison across all platforms, see the [Feature Parity](/documentation/native/feature-parity) page.
</Info>
