...
- **Native Automation**: Learn about [platform automation](/native/overview)
- **Finders**: Master [Patrol's finder system](/documentation/finders/overview)
- **Hot Restart**: Speed up development with [`patrol develop`](/cli/develop)
- **Best Practices**: Read [Effective Patrol](/best-practices/effective-patrol)
- **DevTools Extension**: Try the [Patrol DevTools Extension](/tools/devtools-extension)
- **Web Testing**: Explore [web testing capabilities](/platforms/web)
