...
<Info>
  Learn more about web testing in the [Web Testing Guide](/platforms/web).
</Info>
...
- Check the [platform automation documentation](/native/usage)
...
- Learn about [platform automation features](/native/overview)
- Review [effective Patrol patterns](/best-practices/effective-patrol)
