...
<Info>
  Learn more about [web testing with Patrol](/platforms/web).
</Info>
...
- Explore [web testing capabilities](/platforms/web)
- Try the [VS Code Extension](/tools/vscode-extension)
- Learn about [advanced platform automation](/native/advanced)
- Review [best practices](/best-practices/effective-patrol)
